    ...
    <div class="nav-h" id="myDIV1">
        <div class="menu-content">
            ...
            <div class="drop-down" id="myDIV3">
                ...
                <div class="content"><a href="specials.php" class="e">Specials</a><a href="#" class="f">Music</a></div>
            </div>
            ...
            <div class="drop-down" id="myDIV5">
                ...
                <div class="content"><a href="subbed.php" class="a">Subbed</a><a href="dubbud.php" class="b">Dubbed</a></div>
            </div>
